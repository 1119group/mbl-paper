...
quantitative understanding about their effects.  %%\cite{vedika2017}.  Most of
...
\begin{figure}
  \includegraphics[angle=-90,width=0.82\linewidth]{entropy_plot.ps} \\
  \includegraphics[angle=-90,width=0.82\linewidth]{dispersion_plot.ps} \\
...
<\Psi(0)|S_j^z(0)S_j^z(t)|\Psi(0)>$, which detects the  total imbalance of
...
<\Psi(t)|S_i^zS_j^z|\Psi(t)>^2$,  which can diverge with $L$ in the spin-glass
