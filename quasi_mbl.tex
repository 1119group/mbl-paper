...
\begin{figure}
  \begin{tikzpicture}
    \node (o) at (0, 0) {};
    \node (a) [above] at (o) {\includegraphics[angle=-90,width=0.85\linewidth]{entropy_plot.eps}};
    \node (b) [below] at (o) {\includegraphics[angle=-90,width=0.85\linewidth]{variance_plot.eps}};
...
\begin{figure*}[t]
	\centering
    (a) \includegraphics[angle=-90,width=.30\linewidth]{newfig1c.ps}
    (b) \includegraphics[angle=-90,width=.30\linewidth]{newfig1d.ps}
    (c) \includegraphics[angle=-90,width=.30\linewidth]{newfig1e.ps}
	\caption{
